...
('".$_SESSION['syear']."', 2, 'MissingAttendance', 'LAST_UPDATE', '2022-06-01'),
...
INSERT INTO `schools` (`id`, `syear`, `title`, `address`, `city`, `state`, `zipcode`, `area_code`, `phone`, `principal`, `www_address`, `e_mail`, `reporting_gp_scale`, `last_updated`, `updated_by`) VALUES (1, 2025, 'Greenwood International School', '2456 Elm Street', 'Springfield', 'USA', 'IL 62704', NULL, NULL, NULL, NULL, NULL, 4.000, '2025-10-25 08:25:23', '1'),
...
(25, '".$_SESSION['syear']."', '2', 'Full Year', 'FY', '1', '".$_SESSION['user_school_beg_date']."', '".$_SESSION['user_school_end_date']."', NULL, NULL, NULL, NULL, NULL, NULL, '2019-07-28 00:26:33', NULL);
--
...
(1, 2, ".$_SESSION['syear'].",'2022-08-04 17:15:19', NULL,'0000-00-00','0000-00-00');
...
".
 ($_SESSION['syear']>'2026'||$_SESSION['syear']<'2025'?
...
(1,13,'2025-08-10','Arthur is allergic to prawns/ crabs. He has recorded medical history of allergic symptoms.  ','2025-08-10 16:31:28',NULL);
...
(1,13,'2025-08-10','10:00AM','10:30AM','Rashes on skin','Treatment given',NULL,'2025-08-10 16:31:28',NULL);
...
(1,13,2025,14,1,'Arthur is doing well in his assignments. ','2025-08-12','2025-08-12 16:32:22',NULL);
